...
public class AppReportMockData {
    ...
    private Map<String, List<Map<String, Object>>> createRankReports() {
        ...
        reports.put(
                "week",
                List.of(
                        reportItem("report_week_001", "AI Infrastructure Investment Outlook", "Mock Research Institute", "2026-05-01", "report", 98, 120),
                        reportItem("report_week_002", "Low-altitude Economy Industry Report", "Mock Industry Lab", "2026-04-20", "report", 87, 86),
                        reportItem("report_week_003", "Advanced Semiconductor Supply Chain", "Mock Technology Center", "2026-03-18", "report", 76, 150)
                )
        );
        reports.put(
                "month",
                List.of(
                        reportItem("report_month_001", "AI Infrastructure Investment Outlook", "Mock Research Institute", "2026-05-01", "report", 92, 120),
                        reportItem("report_month_002", "Low-altitude Economy Industry Report", "Mock Industry Lab", "2026-04-20", "report", 84, 86),
                        reportItem("report_month_003", "Advanced Semiconductor Supply Chain", "Mock Technology Center", "2026-03-18", "report", 79, 150)
                )
        );
        reports.put(
                "year",
                List.of(
                        reportItem("report_year_001", "Advanced Semiconductor Supply Chain", "Mock Technology Center", "2026-03-18", "report", 91, 150),
                        reportItem("report_year_002", "AI Infrastructure Investment Outlook", "Mock Research Institute", "2026-05-01", "report", 88, 120),
                        reportItem("report_year_003", "Low-altitude Economy Industry Report", "Mock Industry Lab", "2026-04-20", "report", 80, 86)
                )
        );
        return reports;
    }
